...
@Component({
  selector: 'OrderNote-home',
  templateUrl: './OrderNote-home.component.html',
  styleUrls: ['./OrderNote-home.component.scss']
})
export class OrderNoteHomeComponent implements AfterViewInit {
